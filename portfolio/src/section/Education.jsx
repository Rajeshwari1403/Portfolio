  ...
  return (
    <section id='education' className='container mx-auto px-8 py-16 bg-white lg:mt-14 scroll-mt-20'>
      <div className='max-w-7xl mx-auto'>
        ...
        <p className='block lg:hidden'>Education is the key</p>
        {/* Layout */}
        <div className='flex flex-col lg:flex-row gap-16 items-start justify-between'>
          {/* Left Side Icon */}
          <div className='mb-8 w-[250px] md:w-[320px] h-[300px] md:h-[400px] bg-blue-100 rounded-3xl mx-auto mt-[-28px] flex items-center justify-center mt-[54px]'>
          ...
          <div className='flex-1 flex flex-col gap-6 mt-[-52px] mb-[-60px]'>
            ...
            <p className='hidden lg:block'>Education is the key</p>
            {EDUCATION.map((edu) => (
